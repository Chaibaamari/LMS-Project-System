...
// export default function ImportErrorsPage({ data }: { data: ApiResponse[] }) { {
// //   const [errors, setErrors] = useState<ImportError[]>([]);
// //   const [summary, setSummary] = useState<ImportSummary>({
// //     fileName: "previsions_import.xlsx",
// //     totalRows: 0,
// //     processedRows: 0,
// //     errorCount: 0,
// //     warningCount: 0,
...
// //         const transformedErrors = data.existing.map((item, index) => ({
// //           id: `err${index + 1}`,
// //           line: item.row,
// //           column: "Prevision", // You might want to adjust this based on your actual data
// //           value: "", // You might want to adjust this based on your actual data
// //           errorType: "Duplicate Entry",
// //           message: item.existence,
// //           severity: "critical" as ErrorSeverity, // All errors from the API seem to be critical
// //           suggestion: "Remove duplicate entry or update existing record"
// //         }));

// //         setErrors(transformedErrors);
        
// //         // Update summary based on the errors
// //         setSummary({
// //           fileName: "previsions_import.xlsx",
// //           totalRows: data.existing.length + 10, // Assuming some rows were successful
// //           processedRows: data.existing.length,
// //           errorCount: data.existing.length,
// //           warningCount: 0,
// //           importDate: new Date().toISOString(),
// //           errorsByType: {
// //             "Duplicate Entry": data.existing.length
// //           }
// //         });
...
// //                   <span className="ml-2">Loading import errors...</span>
// //               </div>
// //           </div>
// //       );
// //     };
...
//                                                 </TableRow>
//                                             )
//                                                 :(data.map((error: { id: string; line: number; column: string; value: string; errorType: string; severity: string; message: string; suggestion?: string }) => (
//                                                     <TableRow key={error.row} className="group">
//                                                         <TableCell className="font-mono">{error.row}</TableCell>
