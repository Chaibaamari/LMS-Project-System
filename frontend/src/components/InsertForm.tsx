...
import { Form, useNavigation,useNavigate, Link } from "react-router-dom"
...
export function DynamicInsertForm() {
        ...
        <div className="container mx-auto py-10 px-4 sm:px-6">
            <Card className="transition-all duration-200">
                <CardHeader className="space-y-1 pb-6">
                    <CardTitle className="text-2xl font-bold text-center sm:text-left">Employee Information Insert</CardTitle>
                    <CardDescription className="text-muted-foreground">Insert New  employee in the form below</CardDescription>
                </CardHeader>
                <CardContent>
                                        ...
                                        {field.type === "input" && (
                                            <>
                                                <Input
                                                    ...
                                                    onMouseDown={()=> setValidated(true)}
                                                />
                                                {(editFormData[field.name].length === 0) && Validated &&
                                                    <p className="bg-red-100 text-red-800 p-3 rounded mb-4 flex">veuillez entrer une {field.name} valid</p>
                                                }
                                            </>
                                        )}
                                        {field.type === "select" && (
