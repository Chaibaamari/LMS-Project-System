...
class NotifieExport implements FromQuery,WithHeadings, WithMapping , WithStyles, ShouldAutoSize
{
    use Exportable;
    ...
    public function map($plan): array
    {
        return [
            ...
            $plan->Mode_Financement,
            $plan->Frais_Pedagogiques,
            $plan->Frais_Hebergement,
            $plan->Frais_Transport,
        ];
    }
